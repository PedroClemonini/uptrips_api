...
Route::get('/user/{user}/reservation', [ReservationController::class, 'showReservation']);
...
Route::prefix('hosting')->group(function () {
    ...
    Route::get('/{hosting}/accommodation', [AccommodationController::class, 'index']);
...
Route::prefix('packages')->group(function () {
    ...
    Route::get('/{packages}', [TripPackagesController::class, 'show']);
    Route::put('/{packages}', [TripPackagesController::class, 'update']);
    Route::delete('/{packages}', [TripPackagesController::class, 'destroy']);
});


Route::prefix('accommodation')->group(function () {
    Route::get('/{accomodation}', [AccommodationController::class, 'show']);
    Route::post('/', [AccommodationController::class, 'store']);
